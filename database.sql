...
--SELECT * FROM "accounts" WHERE "account_balance" = 0 AND "transactions_completed" = 0;
UPDATE "accounts" SET "account_balance"=10.00 WHERE "account_balance" = 0 AND "transactions_completed" = 0;
...
INSERT INTO "accounts" ("username", "city", "transactions_completed", "transactions_attempted", "account_balance") VALUES ('kye', 'minneapolis', 1, 10, 200.00);
...
SELECT user_id FROM "accounts" WHERE "username" = 'anthony';
UPDATE "accounts" SET "city"='santa fe' WHERE user_id = 5;
-- 2.	Grace closed her account.
SELECT user_id FROM "accounts" WHERE "username" = 'grace';
